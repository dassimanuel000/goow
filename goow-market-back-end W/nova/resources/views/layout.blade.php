        ...
        <div v-cloak class="flex min-h-screen">
            ...
            <div class="min-h-screen flex-none pt-header min-h-screen w-sidebar bg-grad-sidebar px-6">
                <a href="{{ \Laravel\Nova\Nova::path() }}">
                    <div class="absolute pin-t pin-l pin-r bg-logo flex text-right text-3xl w-sidebar h-header px-6 text-white">
                       <span class="absolute" style="top: 50%; font-size: 22px; transform: translateY(-50%); ">GooW</span>
                    </div>
                </a>
