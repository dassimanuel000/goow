          ...
          <div class="form__group">
            <label class="form__label">
              ...
              <a
                ...
                @click="
                  activityModal = true
                  errors.clear('merchant.activity_id')
                "
              >
                {{ selectedActivity.title }}
                <img
                  v-if="selectedActivity.icon"
                  class="form__icon"
              ...
              <a
                v-else
                class="form__activity form__activity--border"
                @click="
                  activityModal = true
                  errors.clear('merchant.activity_id')
                "
            ...
            <p v-if="errors.has('merchant.activity_id')" class="form__error">
          ...
          <div class="form__group">
            <label class="form__label">
              ...
              <input
                ...
                @input="errors.clear('merchant.title')"
              />
            </label>
          ...
          <div class="form__group">
            <label class="form__label">
              ...
              <input
                ...
                type="text"
                placeholder="Prénom"
                @input="errors.clear('user.last_name')"
              />
            </label>
            <p v-if="errors.has('user.last_name')" class="form__error">
          ...
          <div class="form__group">
            <label class="form__label">
              ...
              <input
                ...
                type="email"
                placeholder="Email"
                @input="errors.clear('user.email')"
              />
            </label>
            <p v-if="errors.has('user.email')" class="form__error">
...
export default {
  ...
  methods: {
    async submit() {
      try {
        this.loading = true
        this.formData.merchant.market_id = this.market.id
        await this.$axios.post('auth/register-merchant', this.formData)
        this.reset()
        this.active = false
        this.$nuxt.$emit('merchant-created')
        this.loading = false
      } catch (e) {
    ...
    reset() {
      ...
      this.formData.merchant.title = ''
      this.formData.merchant.market_id = ''
      this.formData.merchant.activity_id = ''
    },
  },
}
</script>
